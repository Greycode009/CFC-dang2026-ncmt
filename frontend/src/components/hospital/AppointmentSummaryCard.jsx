      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 shadow-xs p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Hospital / Clinic</p>
        ...
        <div className="bg-slate-50 rounded-2xl p-4 flex items-center justify-between border border-slate-100">
          ...
          <span className="text-sm font-extrabold text-[#0d9488]">NPR {registrationFee !== undefined && registrationFee !== null ? registrationFee : 500}</span>
        </div>
        ...
        <p className="text-[10px] text-slate-400 text-center leading-relaxed">
          By confirming, you agree to our patient clinical code guidelines. Registration fee of NPR {registrationFee || 500} is payable at facility reception.
        </p>
      </div>
    </div>
  );
