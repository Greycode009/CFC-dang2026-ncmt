      ...
      <div className="px-6 py-6 border-b border-slate-700/50">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <span className="block text-[10px] font-semibold text-teal-400 uppercase tracking-widest">Admin Panel</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-5 border-t border-slate-700/50 space-y-3">
        <div className="flex items-center space-x-3 px-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px] text-slate-500 truncate">{user?.email || "admin@medassist.com"}</p>
          </div>
        </div>
        <button
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-[60] w-10 h-10 bg-[#1a2332] text-white rounded-xl flex items-center justify-center shadow-lg cursor-pointer"
      >
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static z-50 top-0 left-0 h-screen w-[260px] bg-[#111827] flex-shrink-0 transform transition-transform duration-300 ${
