...
import { FaUserPlus, FaEye, FaEyeSlash, FaSpinner, FaCheckCircle, FaExclamationCircle } from "react-icons/fa";
...
const PatientRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setToast({
      ...
      message: "Please wait while we set up your patient account.",
    });
    ...
    try {
      ...
      setToast({
        ...
        message: "Your patient account has been created. Redirecting...",
      });
