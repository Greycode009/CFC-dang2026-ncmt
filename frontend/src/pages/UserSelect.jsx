...
const UserSelect = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-73px)] w-full bg-[#f8faf9] flex flex-col justify-between p-6 sm:p-10 lg:p-12">



      {/* 2. MAIN CENTERED SECTION */}
      <div className="w-full max-w-3xl mx-auto my-auto py-6 text-center space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
          ...
          <div
            ...
            className={`cursor-pointer bg-white rounded-2xl p-8 sm:p-10 text-center flex flex-col items-center justify-center min-h-[220px] transition duration-200 ${selectedType === "patient"
          ...
          <div
            ...
            className={`cursor-pointer bg-white rounded-2xl p-8 sm:p-10 text-center flex flex-col items-center justify-center min-h-[220px] transition duration-200 ${selectedType === "institute"
              ? "border-2 border-[#0d9488] shadow-xs"
              : "border border-slate-200 hover:border-[#0d9488]/60"
              }`}
          >
